export const countries = [
  {
    ...
    descriptionEn: "Home of chanson, electronic music, and modern rap.",
  ...
  {
    name: 'Brazil',
    descriptionFr: "Samba, bossa nova, MPB, au cœur d'une culture vibrante.",
    descriptionEn: "Samba, bossa nova, and MPB from a vibrant culture.",
  ...
  {
    name: 'Spain',
    descriptionFr: "Flamenco, musique gitane, et pop moderne.",
    descriptionEn: "Flamenco, gypsy music, and modern pop.",
  ...
  {
    name: 'Kenya',
    descriptionFr: "Afro-pop, genge, benga et musique traditionnelle des hauts plateaux.",
  ...
  {
    name: 'Uganda',
    descriptionFr: "Afrobeats, kadongo kamu et fusion afro-électronique.",
  ...
  {
    name: 'Rwanda',
    descriptionFr: "Afrobeat, gospel, et musique traditionnelle des collines.",
